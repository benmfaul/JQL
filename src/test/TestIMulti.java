...
public class TestIMulti extends TestCase {
	...
	@Test public void test() throws Exception {
		...
		Object result2 = jql.execute(mq);
		System.out.println("Result2 = " + result2); 

		//mq = "select customer, id, alsoOwns from xxx  where  alsoOwns CONTAINS zzz ('m60','drill');";
		//Object result3 = jql.execute(mq);
		
		mq = "select customer, id, alsoOwns from xxx  where  alsoOwns CONTAINS 'a';";
		Object result3 = jql.execute(mq);
