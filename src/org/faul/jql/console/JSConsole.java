...
/**
 * Provides a simple Swing based console for use with JQL.
 * @author Ben Faul
 *
 */
public class JSConsole extends JFrame implements ActionListener
{
    ...
    /**
     * Instantiates the File/Load file browser.
     * 
     */
    ...
    /**
     * The JConsole constructor that presents the Swing gui.
     * 
     * @param args [] String. Ignored.
     */
    public JSConsole(String[] args) {
        super("Rhino/Jql JavaScript Console");
    ...
    /**
     * Handle menu item slections.
     * 
     * @param e. ActionEvent - The menu item action to handle.
     */
