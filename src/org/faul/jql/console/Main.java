    ...
    public static void processSource(Context cx, String filename)
    {
        if (filename == null || filename.equals("-")) {
            ...
            if (filename == null) {
                ...
                ps.println(cx.getImplementationVersion() + "/With Jql 0.0.1 support.\n" +
                "This is open source software (GNU v3+)and includes source code from:\n" +
                "Mozilla and JavaCC and is linked with libraries from Google and Mozilla\n");
            }
