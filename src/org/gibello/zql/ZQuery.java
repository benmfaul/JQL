...
public class ZQuery implements ZStatement, ZExp {
   ...
   */
  public void addSelect(List s) { select_ = s; }

  /**
   * Insert the FROM part of the statement
   * @param f a Vector of ZFromItem objects
   */
  public void addFrom(List f) { from_ = f; }

  public void addLimit(ZExp limit) {
	  this.limit = limit;
  }
  
  public void addOffset(ZExp offset) {
	  this.offset = offset;
  }
  
  public ZExp getLimit() {
	  return limit;
  }
  
  public ZExp getOffset() {
	  return offset;
  }
   ...
   * @param v A vector of ZOrderBy objects
   */
  public List getOrderBy() { return orderby_; }
